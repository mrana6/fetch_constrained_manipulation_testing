...
cart_file_path = 'data/eef/urdf/hat_reach.txt';
...
% 
% start_conf =  [1.480381 -0.519910 2.330502 0.773411 0.576692 2.159374 1.160902]';
% end_conf = [1.364771 -0.558937 2.354118 1.267287 0.581348 1.774089 0.915123]';
...
for i = 0 : total_time_step
    ...
    orient = quatmultiply(orient, q_correction);
    orient_mat = [orient_mat; orient];
...
show(robot,robot_conf, 'PreservePlot', false); hold on;
plotEnvironment(obs_info);
pause;

for j = 1:size(output_traj,1)
    robot_conf(7:13) =  output_traj(j,:).';
    show(robot,robot_conf,'PreservePlot', false);
    drawnow;
    pause(0.01);
end
